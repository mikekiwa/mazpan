...
public class TercerosService : System.Web.Services.WebService
{
    ...
    public DataTable allTerceros()
    {
        ...
        String query = " SELECT * FROM [PracticaDb].[dbo].Terceros ";
    ...
    {
        string query = " INSERT INTO [PracticaDb].[dbo].Terceros (nombre,direccion,fono,eMail) VALUES ('" + t.nombre + "','" + t.direccion + "','" + t.fono + "','" + t.eMail + "') ";
    ...
    {
        string query = " DELETE [PracticaDb].[dbo].Terceros WHERE id='"+t.id+"' ";
        if (Ejecutar(query) == 1) return 1;
        else return 0;
    }
    ...
    public DataTable allTrabajosTerceros()
    {
        ...
        SqlConnection cn = new SqlConnection(coneccionString);
        SqlDataAdapter da = new SqlDataAdapter();
        String query = " SELECT * FROM [PracticaDb].[dbo].TrabajoTerceros T1 JOIN [PracticaDb].[dbo].Terceros T2 ON T1.agenteExterno=T2.id ";
    ...
    {
        string query = " INSERT INTO [PracticaDb].[dbo].TrabajoTerceros (trabajo,costo,agenteExterno) VALUES ('"+tt.trabajo+"','"+tt.costo+"','"+tt.agenteExterno+"') ";
        if (Ejecutar(query) == 1) return 1;
        else return 0;
    }
    ...
    {
        string query = " DELETE [PracticaDb].[dbo].TrabajoTerceros WHERE id='" + tt.id + "' ";
        if (Ejecutar(query) == 1) return 1;
        else return 0;
    }
