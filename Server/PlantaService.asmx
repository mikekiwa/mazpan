<%@ WebService Language="C#" CodeBehind="/App_Code/PlantaService.cs" Class="PlantaService" %>
...
public class PlantaService : System.Web.Services.WebService
{
    ...
    public DataTable allPlantas()
    {
        ...
        String query = "SELECT * FROM " + MAER + ".[Planta]";
    ...
    public int addPlanta(Planta p)
    {
        ...
        String query = " INSERT INTO " + MAER + ".[Planta](codigo,nombre,puestaMarcha,encargado,descripcion) " +
    ...
    {
        String query = "DELETE FROM " + MAER + ".[Planta] WHERE codigo='" + p.codigo + "'";
